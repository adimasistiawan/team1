...
class ChangePasswordCompany extends StatefulWidget {
  @override
  _ChangePasswordCompanyState createState() => _ChangePasswordCompanyState();
}
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    TextFormField(
                      obscureText: true,
                      controller: _companyController.oldpass,
                    ...
                    TextFormField(
                        obscureText: true,
                        controller: _companyController.connewpass,
                        decoration: InputDecoration(
                        ...
                        validator: (value) {
                          print(_companyController.newpass.text);
                          if (value.trim().isEmpty) {
                            return 'Confirm new password required';
                          } else if (value.trim().length < 8) {
                            return 'Minimum 8 characters';
                          } else if (value != _companyController.newpass.text) {
